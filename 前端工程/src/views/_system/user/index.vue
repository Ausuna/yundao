<template>
  <div class="app-container">
    <!--查询  -->
    <el-row>
      <el-input style="width:200px;" v-model="tableQuery.uid" placeholder="id"></el-input>
    ...
    <el-table style="width: 100%"
      ...
      <el-table-column prop="nick" label="电话"></el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="20%">
      <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="120px">
        ...
        <el-form-item label="电话" prop="nick">
