<template>
  <div class="app-container">
    <!--查询-->
    <el-row>
      <el-input style="width:200px;" v-model="tableQuery.cname" placeholder="班级id"></el-input>
      <span style="margin-right: 15px;"></span>
      <el-input style="width:200px;" v-model="tableQuery.rval" placeholder="课程名称"></el-input>
      <span style="margin-right: 15px;"></span>
    ...
    <el-table style="width: 100%"
      ...
      <el-table-column prop="rid" label="班级id" ></el-table-column>

      <el-table-column prop="rdesc" label="课课名称" ></el-table-column>
      <el-table-column prop="rval" label="学院名称" ></el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="30%">
      <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="150px" >
        ...
        <el-form-item label="课程描述" prop="rdesc">
...
<script>
  ...
  export default {
    ...
    watch:{
      //延时查询
      'tableQuery.cname': debounce( function(){
        this.fetchData()
      },500),
