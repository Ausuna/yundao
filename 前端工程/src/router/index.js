...
export const asyncRouterMap = [

  {
    path: '/system',
    component: Layout,
    meta: { perm:'m:sys', title: '基本信息', icon: 'chart' },
    children: [
      {
        path: 'user_manage',
        name: 'user_manage',
      ...
      },
      {
        ...
        meta: { perm: 'm:sys:role', title: '班课管理', icon: 'chart', noCache: true },
      },
      {
        hidden: true,
  ...
  //     meta: { perm:'m:menu1', title: '签到管理', icon: 'icon' }
  //   }]
  // },
    ...
    children: [
      {
        ...
        children: [
          { path: 'a', name: 'menu4_1_a', component: _import('menu/menu4_1/a'), meta: { perm:'m:menu4:1:a', title: '查看签到信息' }}
        ]
      },
